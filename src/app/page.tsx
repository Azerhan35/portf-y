...
export default async function Home() {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-8 px-6 py-16 text-center sm:py-24">
      <div className="flex flex-col items-center gap-4">
        <p className="font-mono text-xs tracking-[0.3em] text-accent-gold uppercase">
          Insider · Institutional · Congress
        </p>
        <h1 className="max-w-2xl font-display text-4xl font-medium tracking-tight italic sm:text-5xl">
          Know what they know.
        </h1>
      ...
      <p className="mt-8 font-mono text-sm text-text-muted">
        Free to start (2 tickers, 3-day history) · $19/month for unlimited · cancel anytime
      </p>
      <p className="max-w-md text-xs text-text-muted">
        Portfey surfaces public regulatory filings for informational purposes only. Nothing on
